...
{
    public class RegiaoMonitoradaUpdateDto
    {
        ...
        public string NmRegiao { get; set; } = "Encosta Norte";
        ...
        public string NmCidade { get; set; } = "São Paulo";
        ...
        public string SgEstado { get; set; } = "SP";
        ...
        public decimal NrLatitude { get; set; } = -23.55m;
